    ...
    <header class="bg-white-only header header-md navbar navbar-fixed-top-xs">
        <div class="navbar-header aside bg-info nav-xs">
            ...
            <a href="index.html" class="navbar-brand text-lt">
                ...
                <img src="<?php echo base_url(); ?>public/images/logo.png" alt="." class="hide">
                            ...
                            <div class="list-group list-group-alt">
                                <a href="#" class="media list-group-item">
                                            <span class="pull-left thumb-sm">
                                                <img src="<?php echo base_url(); ?>public/images/a0.png" alt="..." class="img-circle">
                                            </span>
                        ...
                        <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
                            ...
                            <nav class="nav-primary hidden-xs">
                                <ul class="nav bg clearfix">
                                    ...
                                    <li>
                                        <a href="index.html">
                                            <i class="icon-disc icon text-success"></i> <span class="font-bold">What's new</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="genres.html">
                                            <i class="icon-music-tone-alt icon text-info"></i> <span class="font-bold">Genres</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="events.html">
                                    ...
                                    <li>
                                        <a href="listen.html">
                                            <i class="icon-list icon text-info-dker"></i> <span class="font-bold">Listen</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="video.html" data-target="#content" data-el="#bjax-el" data-replace="true">
                                            <i class="icon-social-youtube icon text-primary"></i> <span class="font-bold">Video</span>
                                        </a>
                                    </li>
                                ...
                                <ul class="nav" data-ride="collapse">
                                        ...
                                        <ul class="nav dk text-sm">
                                            ...
                                            <li >
                                                <a href="layout-boxed.html" class="auto">
                                                    <i class="fa fa-angle-right text-xs"></i> <span>Boxed layout</span>
                                                </a>
                                            </li>
                                            <li >
                                                <a href="layout-fluid.html" class="auto">
                                                    <i class="fa fa-angle-right text-xs"></i> <span>Fluid layout</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li >
                                        <a href="#" class="auto">
                                                    <span class="pull-right text-muted"> <i class="fa fa-angle-left text"></i>
                                                        <i class="fa fa-angle-down text-active"></i>
                                                    </span>
                                        ...
                                        <ul class="nav dk text-sm">
                                            <li >
                                                <a href="buttons.html" class="auto">
                                                    <i class="fa fa-angle-right text-xs"></i> <span>Buttons</span>
                                                </a>
                                            </li>
                                            <li >
                                            ...
                                            <li >
                                                <a href="grid.html" class="auto">
                                                    <i class="fa fa-angle-right text-xs"></i> <span>Grid</span>
                                                </a>
                                            </li>
                                            <li >
                            ...
                            <div class="dropdown dropup wrapper-sm clearfix">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                                    <span class="thumb-sm avatar pull-left m-l-xs">
                                                        <img src="<?php echo base_url(); ?>public/images/a3.png" class="dker" alt="...">
                            ...
                            <div class="row row-sm">
                                <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                    <div class="item">
                                        <div class="pos-rlt">
                                            ...
                                            <a href="#">
                                                <img src="<?php echo base_url(); ?>public/images/p1.jpg" alt="" class="r r-2x img-full">
                                            </a>
                                        </div>
                                        <div class="padder-v">
                                    ...
                                    <div class="item"> <div class="pos-rlt">
                                            <div class="item-overlay opacity r r-2x bg-black active">
                                                <div class="text-info padder m-t-sm text-sm">
                                                    ...
                                                    <i class="fa fa-star"></i> <i class="fa fa-star-o text-muted"></i>
                                                    <i class="fa fa-star-o text-muted"></i>
                                                </div>
                                                <div class="center text-center m-t-n">
                                            ...
                                            <a href="#">
                                                <img src="<?php echo base_url(); ?>public/images/p2.jpg" alt="" class="r r-2x img-full">
                                            </a>
                                        </div>
                                        <div class="padder-v"> <a href="#" class="text-ellipsis">Vivamus vel tincidunt libero</a> <a href="#" class="text-ellipsis text-xs text-muted">Lauren Taylor</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                    <div class="item"> <div class="pos-rlt">
                                            ...
                                            <a href="#"><img src="<?php echo base_url(); ?>public/images/p3.jpg" alt="" class="r r-2x img-full"></a>
                                        </div>
                                        <div class="padder-v">
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                    <div class="item"> <div class="pos-rlt">
                                            ...
                                            <a href="#"><img src="<?php echo base_url(); ?>public/images/p4.jpg" alt="" class="r r-2x img-full"></a>
                                        </div>
                                        <div class="padder-v">
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                    <div class="item">
                                        <div class="pos-rlt">
                                            ...
                                            <a href="#"><img src="<?php echo base_url(); ?>public/images/p5.jpg" alt="" class="r r-2x img-full"></a>
                                        </div>
                                        <div class="padder-v">
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                    <div class="item">
                                        <div class="pos-rlt">
                                            ...
                                            <a href="#"><img src="<?php echo base_url(); ?>public/images/p6.jpg" alt="" class="r r-2x img-full"></a>
                                        </div>
                                        <div class="padder-v">
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                    <div class="item">
                                        <div class="pos-rlt">
                                            ...
                                            <a href="#"><img src="<?php echo base_url(); ?>public/images/p7.jpg" alt="" class="r r-2x img-full"></a>
                                        </div>
                                        <div class="padder-v">
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                    <div class="item">
                                        <div class="pos-rlt">
                                            ...
                                            <a href="#"><img src="<?php echo base_url(); ?>public/images/p8.jpg" alt="" class="r r-2x img-full"></a>
                                        </div>
                                        <div class="padder-v">
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                    <div class="item"> <div class="pos-rlt">
                                            ...
                                            <a href="#"><img src="<?php echo base_url(); ?>public/images/p9.jpg" alt="" class="r r-2x img-full"></a>
                                        </div>
                                        <div class="padder-v">
                                        ...
                                        <div class="pos-rlt">
                                            <div class="item-overlay r r-2x bg-light dker active">
                                                <div class="text-info padder m-t-sm text-sm">
                                                    ...
                                                    <i class="fa fa-star"></i>
                                                    <i class="fa fa-star"></i>
                                                    <i class="fa fa-star-o text-muted"></i> </div>
                                                <div class="center text-center m-t-n">
                                            ...
                                            <a href="#"><img src="<?php echo base_url(); ?>public/images/p10.jpg" alt="" class="r r-2x img-full"></a>
                                        </div>
                                        <div class="padder-v">
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                    <div class="item">
                                        <div class="pos-rlt">
                                            ...
                                            <a href="#"><img src="<?php echo base_url(); ?>public/images/p11.jpg" alt="" class="r r-2x img-full"></a>
                                        </div>
                                        <div class="padder-v">
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                    <div class="item">
                                        <div class="pos-rlt">
                                            ...
                                            <a href="#"><img src="<?php echo base_url(); ?>public/images/p12.jpg" alt="" class="r r-2x img-full"></a>
                                        </div>
                                        <div class="padder-v">
                                            ...
                                            <div class="item">
                                                <div class="pos-rlt">
                                                    <div class="item-overlay opacity r r-2x bg-black">
                                                        ...
                                                        </div> </div> <a href="#"><img src="<?php echo base_url(); ?>public/images/a2.png" alt="" class="r r-2x img-full"></a>
                                                </div>
                                                <div class="padder-v">
                                        ...
                                        <div class="col-xs-6 col-sm-3">
                                            <div class="item">
                                                <div class="pos-rlt">
                                                    ...
                                                    <a href="#"><img src="<?php echo base_url(); ?>public/images/a3.png" alt="" class="r r-2x img-full"></a>
                                                </div>
                                                <div class="padder-v">
                                        ...
                                        <div class="col-xs-6 col-sm-3">
                                            <div class="item">
                                                <div class="pos-rlt">
                                                    ...
                                                    <a href="#">
                                                        <img src="<?php echo base_url(); ?>public/images/a8.png" alt="" class="r r-2x img-full">
                                                    </a>
                                                </div>
                                                <div class="padder-v">
                                        ...
                                        <div class="col-xs-6 col-sm-3">
                                            <div class="item">
                                                <div class="pos-rlt">
                                                    ...
                                                    <a href="#">
                                                        <img src="<?php echo base_url(); ?>public/images/a9.png" alt="" class="r r-2x img-full">
                                                    </a>
                                                </div>
                                                <div class="padder-v">
                                        ...
                                        <div class="col-xs-6 col-sm-3">
                                            <div class="item">
                                                <div class="pos-rlt">
                                                    ...
                                                    <a href="#"><img src="<?php echo base_url(); ?>public/images/a1.png" alt="" class="r r-2x img-full"></a>
                                                </div>
                                                <div class="padder-v">
                                        ...
                                        <div class="col-xs-6 col-sm-3">
                                            <div class="item">
                                                <div class="pos-rlt">
                                                    ...
                                                    <a href="#"><img src="<?php echo base_url(); ?>public/images/a6.png" alt="" class="r r-2x img-full"></a>
                                                </div>
                                                <div class="padder-v">
                                        ...
                                        <div class="col-xs-6 col-sm-3">
                                            <div class="item">
                                                <div class="pos-rlt">
                                                    ...
                                                    <a href="#"><img src="<?php echo base_url(); ?>public/images/a7.png" alt="" class="r r-2x img-full"></a>
                                                </div>
                                                <div class="padder-v">
                                        ...
                                        <div class="col-xs-6 col-sm-3">
                                            <div class="item">
                                                <div class="pos-rlt">
                                                    ...
                                                    <a href="#"><img src="<?php echo base_url(); ?>public/images/a5.png" alt="" class="r r-2x img-full"></a>
                                                </div>
                                                <div class="padder-v">
                                                    <a href="#" class="text-ellipsis">Tempered Song</a>
                                                    <a href="#" class="text-ellipsis text-xs text-muted">Miaow</a>
                                    ...
                                    <div class="list-group bg-white list-group-lg no-bg auto">
                                        <a href="#" class="list-group-item clearfix">
                                            ...
                                            <span class="pull-left thumb-sm avatar m-r">
                                                        <img src="<?php echo base_url(); ?>public/images/a4.png" alt="...">
                                                    </span>
                                            <span class="clear">
                                        ...
                                        <a href="#" class="list-group-item clearfix">
                                            ...
                                            <span class="pull-left thumb-sm avatar m-r">
                                                        <img src="<?php echo base_url(); ?>public/images/a5.png" alt="...">
                                                    </span>
                                            <span class="clear">
                                        ...
                                        <a href="#" class="list-group-item clearfix">
                                            ...
                                            <span class="pull-left thumb-sm avatar m-r">
                                                        <img src="<?php echo base_url(); ?>public/images/a6.png" alt="...">
                                                    </span>
                                            <span class="clear">
                                        ...
                                        <a href="#" class="list-group-item clearfix">
                                            ...
                                            <span class="pull-left thumb-sm avatar m-r">
                                                        <img src="<?php echo base_url(); ?>public/images/a7.png" alt="...">
                                                    </span>
                                            <span class="clear">
                                        ...
                                        <a href="#" class="list-group-item clearfix">
                                            ...
                                            <span class="pull-left thumb-sm avatar m-r">
                                                        <img src="<?php echo base_url(); ?>public/images/a8.png" alt="...">
                                                    </span>
                                            <span class="clear">
                            ...
                            <div class="row m-t-lg m-b-lg">
                                ...
                                <div class="col-sm-6">
                                    <div class="bg-black wrapper-md r">
                                        <a href="#">
                                                    <span class="h4 m-b-xs block">
                                                        <i class="icon-cloud-download i-lg"></i> Download our app
                                                    </span>
                                    ...
                                    <div class="jp-gui">
                                        ...
                                        <div class="jp-interface">
                                            <div class="jp-controls">
                                                ...
                                                <div>
                                                    <a class="jp-shuffle" title="shuffle"><i class="icon-shuffle text-muted"></i></a> <a class="jp-shuffle-off hid" title="shuffle off">
                                                        <i class="icon-shuffle text-lt"></i>
                                                    </a>
                                                </div>
                                                <div>
                                                    <a class="jp-repeat" title="repeat"><i class="icon-loop text-muted"></i></a>
                                                    <a class="jp-repeat-off hid" title="repeat off"><i class="icon-loop text-lt"></i></a> </div>
                                                <div class="hide">
                            ...
                            <ul class="list-group no-bg no-borders auto m-t-n-xxs">
                                <li class="list-group-item">
                                                    <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                                                        <img src="<?php echo base_url(); ?>public/images/a1.png" alt="..." class="img-circle">
                                ...
                                <li class="list-group-item">
                                                    <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                                                        <img src="<?php echo base_url(); ?>public/images/a2.png" alt="...">
                                                        <i class="on b-light right sm"></i>
                                                    </span>
                                    <div class="clear"> <div>
                                ...
                                <li class="list-group-item">
                                                <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                                                    <img src="<?php echo base_url(); ?>public/images/a3.png" alt="...">
                                ...
                                <li class="list-group-item">
                                                <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                                                    <img src="<?php echo base_url(); ?>public/images/a5.png" alt="..." class="img-circle">
                                                    <i class="on b-light right sm"></i>
                                                </span>
                                    <div class="clear">
                                        <div>
                                ...
                                <li class="list-group-item">
                                                <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                                                    <img src="<?php echo base_url(); ?>public/images/a6.png" alt="..."> <i class="on b-light right sm"></i>
                                                </span>
                                    <div class="clear">
                                        <div>
                                            <a href="#">Amanda Conlan</a>
                                ...
                                <li class="list-group-item">
                                                <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                                                    <img src="<?php echo base_url(); ?>public/images/a7.png" alt="..."> <i class="busy b-light right sm"></i>
                                                </span>
                                    <div class="clear">
                                        <div>
                                            <a href="#">Dan Doorack</a>
                                ...
                                <li class="list-group-item">
                                                <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                                                    <img src="<?php echo base_url(); ?>public/images/a9.png" alt="..." class="img-circle">
                                                    <i class="on b-light right sm"></i>
                                                </span>
                                    <div class="clear">
                                        <div>
                                ...
                                <li class="list-group-item">
                                                <span class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
                                                    <img src="<?php echo base_url(); ?>public/images/a1.png" alt="...">
                                                    <i class="on b-light right sm"></i>
                                                </span>
                                    <div class="clear">
                                        <div>
